...
const buttonVariants = cva(
  ` inline-flex flex-1 items-center justify-center whitespace-nowrap rounded-lg transition-colors transition-[filter] duration-200 cursor-pointer
  ...
  `,
  {
    variants: {
      ...
      size: {
        ...
        sm: "text-base font-medium gap-1 px-2 py-1 has-[>svg]:px-2.5",
        lg: "text-2xl font-semibold gap-2 w-full px-4 py-3.5 has-[>svg]:px-4 leading-none",
        icon: "p-2 flex-none border",
      },
    },
    defaultVariants: {
      variant: "default",
